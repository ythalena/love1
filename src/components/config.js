const config = {
  ...
  */
  ...
  // 🔐 Passcode Page
  correctPasscode: "1234", // Change this to any 4-digit code (the passcode for access)
  ...
  trendingSearches: [
    "mala peiyun ah", // Example trending search query
    "boomi adhirchi", // Another example query
    `rain`, // A personalized trending search
  ],
